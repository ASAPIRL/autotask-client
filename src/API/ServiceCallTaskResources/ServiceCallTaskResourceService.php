...
class ServiceCallTaskResourceService
{
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function create(ServiceCallTaskResourceEntity $resource): Response
    {
        $serviceCallTaskID = $resource->serviceCallTaskID;
        return $this->client->post("ServiceCallTasks/$serviceCallTaskID/Resources", $resource->toArray());
    }

    /**
     * Deletes an entity by its ID.
     *
     * @param  int  $serviceCallTaskID  ID of the ServiceCallTaskResource parent resource.
     * @param  int  $id  ID of the ServiceCallTaskResource to be deleted.
     *
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function deleteById(int $serviceCallTaskID,int $id): void
    {
        $this->client->delete("ServiceCallTasks/$serviceCallTaskID/Resources/$id");
    }
    ...
    public function getEntityFields(): EntityFieldCollection
    {
        return EntityFieldCollection::fromResponse(
            $this->client->get("ServiceCallTaskResources/entityInformation/fields")
        );
    }
    ...
    public function getEntityInformation(): EntityInformationEntity
    {
        return EntityInformationEntity::fromResponse(
            $this->client->get("ServiceCallTaskResources/entityInformation")
        );
    }
    ...
    {
        return new ServiceCallTaskResourceQueryBuilder($this->client, $this->usePostForQuery);
    }
}
