...
class ResourceService
{
    ...
    public function getEntityFields(): EntityFieldCollection
    {
        return EntityFieldCollection::fromResponse(
            $this->client->get("Resources/entityInformation/fields")
        );
    }
    ...
    public function getEntityInformation(): EntityInformationEntity
    {
        return EntityInformationEntity::fromResponse(
            $this->client->get("Resources/entityInformation")
        );
    }
    ...
    {
        return new ResourceQueryBuilder($this->client, $this->usePostForQuery);
    }
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function update(ResourceEntity $resource): Response
    {
        return $this->client->put("Resources", $resource->toArray());
    }
}
