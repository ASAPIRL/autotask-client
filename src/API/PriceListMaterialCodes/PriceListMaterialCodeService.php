...
class PriceListMaterialCodeService
{
    ...
    public function getEntityFields(): EntityFieldCollection
    {
        return EntityFieldCollection::fromResponse(
            $this->client->get("PriceListMaterialCodes/entityInformation/fields")
        );
    }
    ...
    public function getEntityInformation(): EntityInformationEntity
    {
        return EntityInformationEntity::fromResponse(
            $this->client->get("PriceListMaterialCodes/entityInformation")
        );
    }
    ...
    {
        return new PriceListMaterialCodeQueryBuilder($this->client, $this->usePostForQuery);
    }
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function update(PriceListMaterialCodeEntity $resource): Response
    {
        return $this->client->put("PriceListMaterialCodes", $resource->toArray());
    }
}
