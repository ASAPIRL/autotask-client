 ...
 */
class CompanyWebhookExcludedResourceQueryBuilder
{
    ...
    public function get(): CompanyWebhookExcludedResourceCollection
    {
        ...
        return CompanyWebhookExcludedResourceCollection::fromResponse($response);
    }
    ...
    public function __toString()
    {
        $uri = UriResolver::resolve(
            ...
            new Uri('CompanyWebhookExcludedResources/query')
        );
