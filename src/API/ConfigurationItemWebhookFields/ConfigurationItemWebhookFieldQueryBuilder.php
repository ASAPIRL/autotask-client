 ...
 */
class ConfigurationItemWebhookFieldQueryBuilder
{
    ...
    public function get(): ConfigurationItemWebhookFieldCollection
    {
        ...
        return ConfigurationItemWebhookFieldCollection::fromResponse($response);
    }
    ...
    public function __toString()
    {
        $uri = UriResolver::resolve(
            ...
            new Uri('ConfigurationItemWebhookFields/query')
        );
