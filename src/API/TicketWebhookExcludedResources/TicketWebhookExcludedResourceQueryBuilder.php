 ...
 */
class TicketWebhookExcludedResourceQueryBuilder
{
    ...
    public function get(): TicketWebhookExcludedResourceCollection
    {
        ...
        return TicketWebhookExcludedResourceCollection::fromResponse($response);
    }
    ...
    public function __toString()
    {
        $uri = UriResolver::resolve(
            ...
            new Uri('TicketWebhookExcludedResources/query')
        );
