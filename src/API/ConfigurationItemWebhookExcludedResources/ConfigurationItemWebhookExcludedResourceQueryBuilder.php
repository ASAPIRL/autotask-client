 ...
 */
class ConfigurationItemWebhookExcludedResourceQueryBuilder
{
    ...
    public function get(): ConfigurationItemWebhookExcludedResourceCollection
    {
        ...
        return ConfigurationItemWebhookExcludedResourceCollection::fromResponse($response);
    }
    ...
    public function __toString()
    {
        $uri = UriResolver::resolve(
            ...
            new Uri('ConfigurationItemWebhookExcludedResources/query')
        );
